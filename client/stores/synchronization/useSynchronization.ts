...
if(!SYNC_SERVER_URL){
    throw new Error("Please set EXPO_PUBLIC_SYNC_SEVER_URL in .env to the URL of the sync server")
}

export const useCreateServerSynchronization= <Schemas extends OptionalSchemas>(
    storeId:string,
